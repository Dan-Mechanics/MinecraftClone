...
ChunkMesh::ChunkMesh(const std::vector<ChunkVertex>& vertices, const std::vector<GLuint>& indices) {
	...
	vao.linkAttribute(vbo, 1, 1, GL_INT, sizeof(ChunkVertex), (void*)(3 * sizeof(int)));
	vao.linkAttribute(vbo, 2, 2, GL_FLOAT, sizeof(ChunkVertex), (void*)(3 * sizeof(int) + sizeof(int)));
