...
void Mesh::drawUnlitTexture(const Shader& shader, const Camera& camera, const glm::vec3& translation,
	const glm::quat& rotation, const glm::vec3& scale, const std::vector<Texture>& material) const {
	shader.activate();
	vao.bind();
